...
public class Shop implements Add, Sort, Find {
    ...
    public List<Order> findOrderByEmployee(Employee employee) {
        ...
        for (Order order : orders) {
            if (employee == null) {
                ...
                if (employee.equals(order.getEmployee())) {
                    ordersByEmployee.add(order);
                }
            }
        }
    ...
    public List<Manufacturer> sortManufacturersByName() {
        return manufacturers.stream().sorted((m1, m2) -> {
    ...
    public List<Order> sortOrderByClientId() {
        return orders.stream().sorted(((o1, o2) -> {
            if (o1.getClient() == null && o2.getClient() == null) {
                return 0;
            }
    ...
    public List<Appliance> sortAppliancesByCategory() {
        return appliances.stream().sorted((a1, a2) -> {
