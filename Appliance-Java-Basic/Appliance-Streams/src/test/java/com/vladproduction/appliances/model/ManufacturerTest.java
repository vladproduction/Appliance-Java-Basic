...
class ManufacturerTest {
    ...
    void checkCountConstructors() {
        assertEquals(TestConstants.Manufacturer.CLASS_COUNT_CONSTRUCTORS, allConstructors.size());
    }
    ...
    void checkCountFields() {
        assertEquals(TestConstants.Manufacturer.CLASS_COUNT_FIELDS, allFields.size());
    }
    ...
    void checkModifiersFields() {
        ...
        assertEquals(TestConstants.Manufacturer.CLASS_COUNT_FIELDS, count);
    }
