...
class EmployeeTest {
    ...
    void checkCountConstructors() {
        assertEquals(TestConstants.Employee.CLASS_COUNT_CONSTRUCTORS, allConstructors.size());
    }
    ...
    void checkCountFields() {
        assertEquals(TestConstants.Employee.CLASS_COUNT_FIELDS, allFields.size());
    }
    ...
    void checkAllFieldIsPrivate() {
        final long count = allFields.stream()
                ...
                .count();
        assertEquals(TestConstants.Employee.CLASS_COUNT_FIELDS, count);
    }
    ...
    void checkNameFieldType() {
        final long countLong = allFields.stream()
                .filter(f -> f.getType().getTypeName().equals(TestConstants.STRING_TYPE)
                        & f.getName().equals(TestConstants.Employee.FIELD_DEPARTMENT))
                .count();
