...
class ApplianceTest {
    ...
    void checkCountConstructors() {
        assertEquals(TestConstants.Appliance.CLASS_COUNT_CONSTRUCTORS, allConstructors.size());
    }
    ...
    void checkCountFields() {
        assertEquals(TestConstants.Appliance.CLASS_COUNT_FIELDS, allFields.size());
    }
    ...
    void checkModifiersFields() {
        ...
        assertEquals(TestConstants.Appliance.CLASS_COUNT_FIELDS, count);
    }
