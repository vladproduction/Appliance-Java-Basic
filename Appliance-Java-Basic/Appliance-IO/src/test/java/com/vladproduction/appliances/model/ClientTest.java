...
class ClientTest {
    ...
    void checkCountConstructors() {
        Assertions.assertEquals(TestConstants.Client.CLASS_COUNT_CONSTRUCTORS, allConstructors.size());
    }
    ...
    void checkCountFields() {
        Assertions.assertEquals(TestConstants.Client.CLASS_COUNT_FIELDS, allFields.size());
    }
    ...
    void checkAllFieldIsPrivate() {
        final long count = allFields.stream()
                ...
                .count();
        Assertions.assertEquals(TestConstants.Client.CLASS_COUNT_FIELDS, count);
    }
